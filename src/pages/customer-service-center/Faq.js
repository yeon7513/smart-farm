...
function Faq() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.faq}>
        <div className={styles.title}>
          <h3>대표적인 우리나라 스마트농업 기술을 소개해주세요.</h3>
          {openId === 3 ? (
        ...
        {openId === 3 && (
          <div className={styles.description}>
            <h4>
              3세대 스마트팜 기술을 적용한 스마트 온실 방제 로봇이 있습니다.
              방제로봇은 8시간 이상 연속 운전이 가능하고, 300L 약액통을 장착해
              1회 0.33ha를 방제할 수 있습니다. 또한 마그네틱, 근접 센서, 광학
              검출기 등을 사용해 계획된 경로를 따라 자율주행할 수 있도록
              설정했습니다. 이와 함께 작업자가 직접 기계를 다루지 않아도 지형
              환경을 인식해 스스로 주행하며 농작업이 가능한 자율주행 트랙터를
              비롯해 자율주행 벼 이앙기, 로봇 착유기 국산화 등 스마트농업 기술이
              개발되었습니다. 현재 방제 로봇은 토마토농장에서 현장실증 중이며,
              자율주행 트랙터 등은 현장 보급을 위해 노력하고 있습니다.
            </h4>
          </div>
        )}
      </div>
