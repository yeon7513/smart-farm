          ...
          {openId === 2 && (
            <div className={styles.description}>
              <h4>
                ...
                있습니다. 로봇, 드론, 자율주행 등 자동화 기술을 도입하면 한층
                편리하게 농작업을 할 수 있고, 작물 생산성을 높일 수 있습니다.
              </h4>
            </div>
          )}
        </div>
          ...
          {openId === 4 && (
            <div className={styles.description}>
              <h4>
                ...
                결과, 생산성이 토마토 농장은 13.7%, 딸기 농장은 30%
                높아졌습니다. 또한 자율주행 벼 이앙기를 사용하면 노동력을 50%
                가량 줄일 수 있습니다. 드론으로 방제할 경우 노동력은 87%, 농약이
                날아서 흩어지는 양은 30% 가량 줄어든 것으로 나타났습니다. 그동안
                해외에서 수입해 온 로봇 착유기는 국산화에 성공함으로써 외국산
                대비 설치비를 60% 줄이는 효과를 냈습니다.
              </h4>
            </div>
          )}
        </div>
