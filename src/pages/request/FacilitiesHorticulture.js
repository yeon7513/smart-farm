...
const options = {
  "환경 제어": [
    { id: "thermostat", value: "온도 조절기", label: "온도 조절기" },
    { id: "ventilationSystem", value: "환기 장치", label: "환기 장치" },
    { id: "shadingFilm", value: "차광막", label: "차광막" },
  ],
  "조명 시스템": [
    { id: "LEDGrowLights", value: "인공 조명", label: "인공 조명" },
    {
  ...
  "관수 시스템": [
    ...
    { id: "positiveLiquidMachine", value: "양액기", label: "양액기" },
  ],
  "센서 및 모니터링": [
    {
    ...
    { id: "CO2Sensor", value: "CO2 센서", label: "CO2 센서" },
  ],
  "기타 장비": [
    {
